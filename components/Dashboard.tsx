        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            <nav className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-6 py-4 flex justify-between items-center sticky top-0 z-10">
                ...
                <div className="flex items-center gap-4">
                    <button
                        onClick={onUpgrade}
                        className="flex items-center gap-2 px-3 py-2 sm:px-4 bg-gradient-to-r from-amber-200 to-yellow-400 hover:from-amber-300 hover:to-yellow-500 text-amber-900 rounded-full font-bold text-xs sm:text-sm shadow-md transition-all transform hover:scale-105"
                    >
                        <Crown size={16} /> <span className="hidden xs:inline">Upgrade</span>
                    </button>
